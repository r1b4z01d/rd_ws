...
export const panels = {
  ...
  callPartyService: "Party Service Call",
  callPartyServiceDescription: "Go To Charger",
  callEStopService: "E-Stop Service Call",
  callEStopServiceDescription: "Call the E-Stop service.",
  callChargerService: "Charger Service Call",
  callChargerServiceDescription: "Call The Go To Charger Service.",
